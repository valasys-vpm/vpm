...
$(function (){
    ...
    CAMPAIGN_TABLE = $('#table-campaigns').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": URL + '/vendor-manager/ra/campaign/get-campaigns',
            data: {
                filters: function (){
                    let obj = {
                    };
        ...
        "columns": [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return '<a href="'+URL+'/vendor-manager/ra/campaign/view-details/'+btoa(row.id)+'" class="text-dark double-click" title="View campaign details">'+row.campaign.name+'</a>';
                }
            },
            {
                orderable: false,
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    let html = '';
                    html += '<a href="'+URL+'/vendor-manager/ra/campaign/view-details/'+btoa(row.id)+'" class="btn btn-outline-info btn-rounded btn-sm" title="View Campaign Details"><i class="feather icon-eye mr-0"></i></a>';
                    return html;
                }
            },
        ],
