...
$(function (){
    ...
    $.validator.addMethod(
        ...
        function(value, element) {
            var data;
            $.ajax({
                url: URL + '/vendor-manager/ra/lead/check-suppression-domain/' + $('#ca_agent_id').val(),
                data: {
    ...
    $.validator.addMethod(
        ...
        function(value, element) {
            let data;
            $.ajax({
                url: URL + '/vendor-manager/ra/lead/check-target-domain/' + $('#ca_agent_id').val(),
                data: {
                    company_domain: value
                },
                dataType: 'json',
    ...
    $("#form-lead-create").validate({
        ...
        rules: {
            ...
            'company_name' : {
                ...
                remote : {
                    url : URL + '/vendor-manager/ra/lead/check-suppression-account-name/' + $('#ca_agent_id').val(),
                    data : {
            ...
            'email_address' : {
                ...
                remote : {
                    url : URL + '/vendor-manager/ra/lead/check-suppression-email/' + $('#ca_agent_id').val(),
                    data : {
