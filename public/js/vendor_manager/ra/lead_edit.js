...
$(function (){
    ...
    $.validator.addMethod(
        ...
        function(value, element) {
            var data;
            $.ajax({
                url: URL + '/vendor-manager/ra/lead/check-suppression-domain/' + $('meta[name="ca-agent-id"]').attr('content'),
                data: {
    ...
    $.validator.addMethod(
        ...
        function(value, element) {
            let data;
            $.ajax({
                url: URL + '/vendor-manager/ra/lead/check-target-domain/' + $('meta[name="ca-agent-id"]').attr('content'),
                data: {
                    company_domain: value
                },
                dataType: 'json',
    ...
    $("#form-lead-edit").validate({
        ...
        rules: {
            ...
            'company_name' : {
                ...
                remote : {
                    url : URL + '/vendor-manager/ra/lead/check-suppression-account-name/' + $('meta[name="ca-agent-id"]').attr('content'),
                    data : {
