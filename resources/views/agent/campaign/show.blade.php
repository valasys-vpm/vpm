                                            ...
                                            <ul class="media-list p-0" id="specification_ul">
                                                ...
                                                @forelse($resultCampaignParent->specifications as $specification)
                                                    ...
                                                    <li class="media d-flex m-b-15 specification-li">
                                                        ...
                                                        <div class="media-body">
                                                            <a href="{{ url('public/storage/campaigns/'.$resultCampaignParent->campaign_id.'/'.urlencode($specification->file_name)) }}" class="double-click" target="_blank" download data-toggle="tooltip" data-placement="top" data-original-title="{{ $specification->file_name }}"><span class="m-b-5 d-block text-primary">@if(strlen($specification->file_name) < 30) {{ $specification->file_name }} @else {{ substr($specification->file_name, 0, 27).'...' }} @endif</span></a>
                                                        </div>
                                                    </li>
                                                @empty
                                                    @php $flag = 1; @endphp
