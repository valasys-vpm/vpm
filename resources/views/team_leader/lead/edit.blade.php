                                ...
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        ...
                                        <div class="card-header-right mb-1" style="float: right;">
                                            <a href="{{ route('team_leader.lead.list', base64_encode($resultCAAgent->campaign_assign_ratl_id)) }}" class="btn btn-outline-info btn-square btn-sm pt-1 pb-1" style="font-weight: bold;"><i class="feather icon-arrow-left"></i>Back</a>
                                        </div>
                                    </div>
                                    <ul class="breadcrumb">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="form-lead-edit" method="post" action="{{ route('team_leader.lead.update', base64_encode($resultAgentLead->id)) }}">
                                                        @csrf
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 form-group">
                                                                ...
                                                                <input autofocus type="text" class="form-control btn-square" id="comment" name="comment" placeholder="Enter comment" value="{{ $resultAgentLead->comment }}">
                                                            </div>
                                                        </div>
