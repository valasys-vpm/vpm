                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('email_marketing_executive.campaign.show', base64_encode($resultCAAgent->campaign_id)) }}">Campaign Details</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('email_marketing_executive.lead.list', base64_encode($resultCAAgent->id)) }}">Manage Leads</a></li>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="form-lead-create" method="post" action="{{ route('email_marketing_executive.lead.store') }}">
                                                        @csrf
                                                        @if(isset($resultData))
...
@section('javascript')
    ...
    <!-- page custom Js -->
    <script src="{{ asset('public/js/email_marketing_executive/lead_create.js?='.time()) }}"></script>
@append
