                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="form-lead-edit" method="post" action="{{ route('email_marketing_executive.lead.update', base64_encode($resultAgentLead->id)) }}">
                                                        @csrf
                                                        <div class="row">
...
@section('javascript')
    ...
    <!-- page custom Js -->
    <script src="{{ asset('public/js/email_marketing_executive/lead_edit.js?='.time()) }}"></script>
@append
