                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('email_marketing_executive.campaign_management.show', base64_encode($resultCampaign->id)) }}">View Details</a></li>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="form-campaign-edit" method="post" action="{{ route('email_marketing_executive.campaign_management.update', base64_encode($resultCampaign->id)) }}">
                                                        @csrf
                                                        <div class="row">
...
@section('javascript')
    ...
    <!-- page custom Js -->
    <script src="{{ asset('public/js/email_marketing_executive/campaign_edit.js?='.time()) }}"></script>
@append
