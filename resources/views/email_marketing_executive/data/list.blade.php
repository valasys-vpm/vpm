                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" class="form-control btn-square" id="employee_size_2" name="employee_size_2" placeholder="Enter size">
                            </div>
                        </div>
...
@section('javascript')
    ...
    <!-- custom Js -->
    <script src="{{ asset('public/js/email_marketing_executive/data.js?='.time()) }}"></script>
@append
