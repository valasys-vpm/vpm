                                ...
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        ...
                                        <div class="card-header-right mb-1" style="float: right;">
                                            <a href="{{ route('quality_analyst.dashboard') }}" class="btn btn-outline-info btn-square btn-sm pt-1 pb-1" style="font-weight: bold;"><i class="feather icon-arrow-left"></i>Back</a>
                                        </div>
                                    </div>
                                    <ul class="breadcrumb">
