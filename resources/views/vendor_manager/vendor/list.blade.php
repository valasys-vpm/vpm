...
@section('content')
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="float-right">
                                                <button type="button" class="btn btn-primary btn-square btn-sm" onclick="addVendor();"><i class="feather icon-plus"></i>New Vendor</button>
                                            </div>
                                        </div>
    ...
    <div id="modalVendor" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4" id="modal-heading">Add new vendor</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <form id="modal-vendor-form">
                        <input type="hidden" name="id" id="id" value="">
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <label for="vendor_id">Vendor Id <span class="text-danger">*</span></label>
                                <input type="text" class="form-control btn-square" id="vendor_id" name="vendor_id" placeholder="Enter vendor id" required>
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="name">Vendor Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control btn-square" id="name" name="name" placeholder="Enter first name" required>
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="email">Vendor Email <span class="text-danger">*</span></label>
                                <input type="email" class="form-control btn-square" id="email" name="email" placeholder="Enter email" required>
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="designation">Designation<span class="text-danger">*</span></label>
                                <input type="text" class="form-control btn-square" id="designation" name="designation" placeholder="Enter vendor designation" required>
                            </div>
                            <div class="col-md-4 form-group">
