                                ...
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        ...
                                        <div class="card-header-right mb-1" style="float: right;">
                                            <a href="{{ route('vendor_manager.ra.campaign.show', base64_encode($resultCAAgent->id)) }}" class="btn btn-outline-info btn-square btn-sm pt-1 pb-1" style="font-weight: bold;"><i class="feather icon-arrow-left"></i>Back</a>
                                        </div>
                                    </div>
                                    <ul class="breadcrumb">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="float-right">
                                                <a href="{{ route('vendor_manager.ra.lead.create', base64_encode($resultCAAgent->id)) }}">
...
@section('javascript')
    ...
    <!-- custom Js -->
    <script src="{{ asset('public/js/vendor_manager/ra/lead.js?='.time()) }}"></script>
@append
