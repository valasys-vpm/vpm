                                ...
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        ...
                                        <div class="card-header-right mb-1" style="float: right;">
                                            <a href="{{ route('vendor_manager.ra.lead.list', base64_encode($resultCAAgent->id)) }}" class="btn btn-outline-info btn-square btn-sm pt-1 pb-1" style="font-weight: bold;"><i class="feather icon-arrow-left"></i>Back</a>
                                        </div>
                                    </div>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{ route('vendor_manager.ra.dashboard') }}"><i class="feather icon-home"></i></a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('vendor_manager.ra.campaign.list') }}">Campaign Management</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('vendor_manager.ra.campaign.show', base64_encode($resultAgentLead->campaign_id)) }}">Campaign Details</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('vendor_manager.ra.lead.list', base64_encode($resultAgentLead->ca_agent_id)) }}">Manage Leads</a></li>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="form-lead-edit" method="post" action="{{ route('vendor_manager.ra.lead.update', base64_encode($resultAgentLead->id)) }}">
                                                        @csrf
                                                        <div class="row">
...
@section('javascript')
    ...
    <!-- page custom Js -->
    <script src="{{ asset('public/js/vendor_manager/ra/lead_edit.js?='.time()) }}"></script>
@append
