                                ...
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        ...
                                        <div class="card-header-right mb-1" style="float: right;">
                                            <a href="{{ route('vendor_manager.dashboard') }}" class="btn btn-outline-info btn-square btn-sm pt-1 pb-1" style="font-weight: bold;"><i class="feather icon-arrow-left"></i>Back</a>
                                        </div>
                                    </div>
                                    <ul class="breadcrumb">
                                ...
                                <div class="col-xl-8 col-lg-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-md-8 offset-2">
                                                    <form id="form-change-password" method="post" action="{{ route('vendor_manager.user.change_password') }}">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-md-12 form-group">
...
@section('javascript')
    ...
    <script src="{{ asset('public/js/vendor_manager/my_profile.js?='.time()) }}"></script>
@append
