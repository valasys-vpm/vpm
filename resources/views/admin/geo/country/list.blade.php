...
@section('content')
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Country Management</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="float-right">
                                                <button type="button" class="btn btn-primary btn-square btn-sm" onclick="addCountry();"><i class="feather icon-plus"></i>New Country</button>
                                            </div>
                                        </div>
                                        <div class="card-block">
                                            <div class="table-responsive">
                                                <table id="table-countries" class="display table nowrap table-striped table-hover">
                                                    <thead>
                                                    <tr>
                                                        <th>Name</th>
                                                        <th>Region</th>
    ...
    <div id="modalCountry" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4" id="modal-heading">Add New Country</h5>
                    ...
                    <form id="modal-role-form">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" class="form-control btn-square" id="name" name="name" placeholder="Enter country name" required>
                            </div>
                        </div>
...
@section('javascript')
    ...
    <script src="{{ asset('public/js/admin/country.js?='.time()) }}"></script>
@append
