                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="float-right">
                                                <button type="button" class="btn btn-primary btn-square btn-sm" onclick="addDesignation();"><i class="feather icon-plus"></i>New Designation</button>
                                            </div>
                                        </div>
                                        <div class="card-block">
                                            <div class="table-responsive">
                                                <table id="table-designations" class="display table nowrap table-striped table-hover">
                                                    <thead>
                                                    <tr>
                                                        <th>Name</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4" id="modal-heading">Add new designation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <form id="modal-designation-form">
                        <input type="hidden" name="designation_id" id="designation_id" value="">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label for="name">Designation Name</label>
                                <input type="text" class="form-control btn-square" id="name" name="name" placeholder="Enter designation name" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 form-group">
...
@section('javascript')
    ...
    <script src="{{ asset('public/js/admin/designation.js?='.time()) }}"></script>
@append
