...
class CreateCampaignAssignEMESTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('campaign_assign_e_m_e_s', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('campaign_assign_e_m_e_s');
    }
}
