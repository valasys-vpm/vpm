...
class CreateCampaignAssignVendorManagersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('campaign_assign_vendor_managers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('campaign_assign_vendor_managers');
    }
}
